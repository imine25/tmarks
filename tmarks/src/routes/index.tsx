...
const BookmarkArchivePage = lazy(() => import('@/pages/bookmarks/BookmarkArchivePage').then(m => ({ default: m.BookmarkArchivePage })))
      ...
      <Routes>
        ...
        <Route element={<ProtectedRoute />}>
          ...
          <Route element={<AppShell />}>
            ...
            <Route path="/bookmarks/archive" element={<BookmarkArchivePage />} />
